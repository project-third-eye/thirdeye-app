...
def load_reference_encoding(captured_image_path):
    ...
    return face_recognition.face_encodings(captured_image)[0]
...
def save_snapshot():
    try:
        ...
        with open(r'D:\snapshot\snapshot.jpg', 'wb') as f:
            ...
            captured_image_path = r"D:\snapshot\snapshot.jpg"
            global reference_encoding 
            reference_encoding = load_reference_encoding(captured_image_path)
